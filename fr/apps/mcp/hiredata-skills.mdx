...
sidebarTitle: "Skills"
description: "Comment les skills HireData guident ChatGPT, Codex et Claude : planifier des activations, créer des workflows, diagnostiquer les problèmes, suivre le ROI."
...
related: ["/fr/apps/mcp/install-hiredata-plugin", "/fr/apps/mcp/install-hiredata-skills-with-a-prompt", "/fr/apps/mcp/keep-hiredata-skills-up-to-date", "/fr/apps/mcp/create-your-own-skill"]
---
...
HireData publie actuellement dix skills : une qui planifie, quatre qui créent, deux qui diagnostiquent, une qui rend compte de ce que les automatisations ont apporté, une qui rédige des rapports d'incident, et une qui apporte la connaissance métier du staffing sur laquelle s'appuient les autres.
...
| --- | --- |
| [Planifier une activation](#planifier-une-activation) | Transformer un problème de recrutement en un plan d'automatisation priorisé et fondé sur des preuves |
| [Créer des triggers](#créer-des-triggers) | Démarrer une automatisation au bon moment, avec les bons filtres et la bonne population |
| [Créer des formulaires](#créer-des-formulaires) | Capturer une décision ou un signal avec le formulaire le plus court possible |
| [Créer des modèles d'e-mail](#créer-des-modèles-d-e-mail) | Rédiger des e-mails avec des variables sûres, des modificateurs et des variables IA bornées |
| [Créer des modèles WhatsApp](#créer-des-modèles-whatsapp) | Concevoir des messages WhatsApp concis qui passent la revue de modèles de Meta |
| [Diagnostiquer les automatisations](#diagnostiquer-les-automatisations) | Comprendre pourquoi un workflow n'a pas fait ce que vous attendiez, et quoi changer |
| [Diagnostiquer la performance des e-mails](#diagnostiquer-la-performance-des-e-mails) | Expliquer une baisse des ouvertures, des clics ou de la délivrabilité, et agir |
| [Rapporter le ROI des automatisations](#rapporter-le-roi-des-automatisations) | Montrer ce que vos automatisations ont réellement apporté, sur des chiffres mesurés |
| [Rédiger des issue reports](#rédiger-des-issue-reports) | Rédiger et affiner des issues Linear HireData avec les sources auxquelles vous avez accès |
| [Appliquer la connaissance du cycle de vie du staffing](#appliquer-la-connaissance-du-cycle-de-vie-du-staffing) | Que votre assistant lise les demandes de recrutement comme le ferait un recruteur |
...
## Créer des modèles d'e-mail {#créer-des-modèles-d-e-mail}
...
Les skills sont fournies avec la connexion MCP HireData dans le plugin HireData — une seule installation couvre les deux. [Installez le plugin HireData](/fr/apps/mcp/install-hiredata-plugin) dans ChatGPT, Codex ou Claude. Pas de prise en charge du plugin sur votre formule ou votre assistant ? [Installez les skills avec un prompt](/fr/apps/mcp/install-hiredata-skills-with-a-prompt) à la place.

HireData améliore ces skills à mesure que le produit évolue et en publie de nouvelles : pensez à [les garder à jour](/fr/apps/mcp/keep-hiredata-skills-up-to-date). Elles sont publiques et ouvertes à consultation sur [github.com/HireData/skills](https://github.com/HireData/skills) — et vous pouvez [créer les vôtres](/fr/apps/mcp/create-your-own-skill) pour le travail que seule votre équipe réalise.

<CardGroup cols={2}>
  <Card title="Installer le plugin" icon="puzzle-piece" href="/fr/apps/mcp/install-hiredata-plugin">
