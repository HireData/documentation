...
sidebarTitle: "Skills"
description: "Comment les dix skills HireData guident ChatGPT, Codex et Claude pour planifier des activations, créer des workflows, diagnostiquer les problèmes et rapporter le ROI."
...
La [connexion MCP HireData](/fr/apps/mcp/connect-hiredata-to-your-ai-assistant) donne à votre assistant IA les outils de HireData. Les skills lui donnent la méthode de travail qui va avec : la façon dont un consultant HireData expérimenté aborderait la tâche, ce qu'il faut d'abord vérifier dans votre workspace, et quand s'arrêter pour vous montrer un aperçu plutôt que de créer quelque chose que vous n'avez pas demandé.
...
| [Créer des modèles d'e-mail](#créer-des-modèles-de-mail) | Rédiger des e-mails avec des variables sûres, des modificateurs et des variables IA bornées |
