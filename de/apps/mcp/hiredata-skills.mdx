...
| [Diagnose automations](#diagnose-automations) | herausfinden möchten, warum ein Workflow nicht das getan hat, was Sie erwartet haben |
| [Diagnose email performance](#diagnose-email-performance) | einen Rückgang bei Öffnungen, Klicks oder Zustellbarkeit erklären und beheben möchten |
| [Write issue reports](#write-issue-reports) | HireData-Linear-Issues mit den Quellen erstellen möchten, auf die Sie Zugriff haben |
| [Apply staffing lifecycle knowledge](#apply-staffing-lifecycle-knowledge) | möchten, dass Ihr Assistent Recruiting-Anfragen so liest wie eine Recruiterin oder ein Recruiter |
