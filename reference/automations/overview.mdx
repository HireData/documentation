...
<Note>
  Add, Find, Message, and Update appear in the picker only when a connected app offers a task in that category. The task catalogue lists those tasks per app.
</Note>
