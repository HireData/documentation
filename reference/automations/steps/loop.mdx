...
<img src="/images/automations/15-loop-drawer.png" alt="The Loop drawer with a filter reading Id equals 6416, Stop on first success set to No, and Output Variable reading candidate with its help text" width="384" />
...
<img src="/images/automations/26-loop-card.png" alt="A Loop box on the canvas with a Loop badge and a card reading Retrieve Candidates from Carerix, hiredata, Filter 1 Id equals 6416" width="380" />
...
<img src="/images/automations/30-loop-failed-timeline.png" alt="A run timeline with Run Scheduled, Run Started, then Loop: Failed with the message Step not found." width="384" />
