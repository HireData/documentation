...
<Note>
  **On the canvas.** An Add task shows a **Task** badge, the task name with the app, and the values it will write, grouped as the app groups them.

  ![An Add Task to Carerix card on the canvas with Characteristics, Content, and Related Records groups, each field filled from a variable](/images/automations/37-add-card.png)
</Note>
...
<Note>
  The settings differ per task. The table names each task; its own page or its app's page lists the fields.
</Note>
