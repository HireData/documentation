...
<img src="/images/automations/22-setup-card.png" alt="The Start node on the canvas: a Start badge, the title Response: Completed, and a Form row reading Docs test: builder reference examples" width="378" />
