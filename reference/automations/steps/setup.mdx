...
<Note>
  **On the canvas.** The Start node carries a **Start** badge, the object and trigger as its title, and the Config rows underneath, such as the form a Response trigger listens to.
...
![The Setup drawer after saving: App HireData, Object Response with an Edit button, Trigger Completed with an Edit button, and a Config card with Form, an All switch that is off, and the selected form](/images/automations/29-setup-drawer.png)
