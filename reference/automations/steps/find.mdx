...
<img src="/images/automations/31-find-cancelled-card.png" alt="A Search Domain task card in a run, red, with Company set to Respondent: Address Company and the line Cancelled: Today at 10:18 AM below it" width="380" />
