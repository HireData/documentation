...
![A run timeline with Search Domain: Cancelled, the message Search domain failure., and Search Domain: Run Cancelled](/images/automations/32-find-cancelled-timeline.png)
