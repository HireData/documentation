...
**Delay** pauses the run for a set time before the next step. The drawer is headed **Delay** and its footer holds **Cancel** and **Save Delay**.
...
<Note>
  **On the canvas.** The card reads the wait in words.

  ![A Delay card on the canvas reading Delay for 5 minutes](/images/automations/24-delay-card.png)
</Note>
