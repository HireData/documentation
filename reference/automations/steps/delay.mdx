...
<img src="/images/automations/12-delay-drawer.png" alt="The Delay drawer with the preset select reading 5 minutes, a Skip Weekends checkbox, and a Custom switch" width="384" />

### On the canvas

The card reads the wait in words.

<img src="/images/automations/24-delay-card.png" alt="A Delay card on the canvas reading Delay for 5 minutes" width="314" />
