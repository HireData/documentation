...
<img src="/images/automations/10-filter-drawer.png" alt="The Filter drawer with two rows in the first set, Question 1: Answer is not empty and Question 2: Answer equals Yes, joined by an AND / OR toggle, then a second toggle and an empty second set" width="384" />

### On the canvas

The card shows a **Filter** badge, the set number, and each row as field, operator, value.

<img src="/images/automations/23-filter-card.png" alt="A Filter card on the canvas reading 1, Question 1: Answer, is not empty" width="365" />
...
<img src="/images/automations/33-filter-passed-card.png" alt="A Filter card in a run reading Meeting: Activity Type one of 2 selected, with the line Completed: Last Friday at 7:42 PM below it" width="380" />

<img src="/images/automations/34-filter-passed-timeline.png" alt="A run timeline with Filter: Run Moved, then Filter: Completed showing set 1 as Valid with Expected Meeting: Activity Type with value 1e gesprek, To be one of 2 selected" width="384" />
...
<img src="/images/automations/38-filter-cancelled-timeline.png" alt="A run timeline with Run Scheduled, Run Started, Run Moved, then Filter: Cancelled with the message Filter not passed. and Filter: Run Cancelled" width="384" />
