...
The card shows a **Task** badge, "Ask AI" followed by the intent, the prompt text, a chip per output field, and the three Advanced values. A variable in the prompt shows as a badge with the field's name.
