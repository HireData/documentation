...
**Update** changes something that already exists in a connected app. The picker describes it as "Changes something that's already there." It is a category. When more than one connected app offers an Update task, choosing it opens a list headed **Update**; when one task fills the category, as Carerix's does on its own, choosing it opens that task's drawer directly.
...
The drawer is headed with the task name and the app's icon, and its footer holds **Back**, **Cancel**, and **Save Task**.
