...
<img src="/images/automations/36-update-card.png" alt="An Update Candidate in Carerix card on the canvas: Find a candidate by matching their Candidate: Id in Carerix with Candidate: Id, and then update these fields, with Available Date set to Now and Status set to Werkzoekend" width="380" />
...
<img src="/images/automations/20-run-step-fields.png" alt="The Fields tab of an Update Match run step listing Match: Id, Match: Stage, an evaluation score, a filtered stage value, and one unresolved variable shown as raw text" width="384" />
