...
- **Brand**, in the toolbar, restyles the **whole email**. Every colour and font still set to a theme value changes at once, in blocks you wrote weeks ago as much as in blocks you add next. Switching an email from one brand to another moves its section background, its button colour, and its heading colour together.
