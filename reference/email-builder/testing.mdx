...
<img src="/images/email-builder/20-preview-rendered.png" alt="A whole email as the preview renders it: the brand logo, a coloured header band, a greeting, body text, three answer buttons, a signature, and the address and unsubscribe footer" width="420" />
...
<img src="/images/email-builder/16-preview-links.png" alt="The Links panel with four rows, the hovered row's button outlined in the preview beside it, a popover showing the full URL and its utm_source, utm_medium, and utm_campaign values, and a UTM Campaign card below the list" width="640" />
...
2. **Check the canvas for orange badges.** An orange badge is a key HireData does not recognise, and it reaches the inbox with its braces showing. Fix or remove each one. See [Variables](/reference/email-builder/variables).
