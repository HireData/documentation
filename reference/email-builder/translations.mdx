...
<img src="/images/email-builder/13-translation-editor.png" alt="A Dutch translation open in the drawer, with Rewrite translations with AI, a delete button, and rows for Subject, Name, and each paragraph showing the English original above the Dutch translation" width="445" />

**Create** saves the translation on its own, without saving the rest of the template. **Cancel** closes it without saving.
