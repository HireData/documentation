...
- **Show variable values** does not fill the canvas in. Variable chips keep their labels either way, so use the [preview](/reference/email-builder/testing#the-preview) to see an email with real values in it.
