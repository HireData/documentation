...
<img src="/images/email-builder/blocks/10-signature-settings.png" alt="The Signature settings panel showing the Image with a brand mark, Color, Background color, the Blocks list of five paragraphs with drag handles only, and the Spacing group holding Margin" width="384" />
