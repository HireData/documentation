...
![The Image settings panel showing the chosen picture, Width set to Auto, Alignment, Height set to Auto, and Border radius](/images/email-builder/blocks/06-image-settings.png)
...
![The media library card for an image, with a Title reading Brand: Banner, an empty Alt text box, and the note "Falls back to image title if left empty."](/images/email-builder/blocks/06b-image-alt-text.png)
