...
<img src="/images/email-builder/blocks/06b-image-alt-text.png" alt="The media library card for a field-backed image, with a read-only Title reading Brand: Banner, an empty Alt text box, and a note saying it falls back to the image title if left empty" width="464" />
