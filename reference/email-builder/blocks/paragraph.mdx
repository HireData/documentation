...
<img src="/images/email-builder/blocks/02-paragraph-settings.png" alt="The Paragraph settings panel showing Font Family, Size, Color, Alignment, the Links group with Inherit selected, and the Advanced group with Letter Spacing, Line Height, and Margin" width="384" />
