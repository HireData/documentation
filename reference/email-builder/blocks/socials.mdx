...
- **Spacing** holds **Margin**, the space above and below the row, and **Gap**, the space between the icons.
- **Text** holds **Size**, which sets the size of the label beside an icon.

![The Socials settings panel showing Alignment, Icon Size at 20, the Socials list with LinkedIn, Instagram, and YouTube rows, the Spacing group with Margin and Gap, and the Text group](/images/email-builder/blocks/07-socials-settings.png)
...
![The Social settings panel showing the URL box with a LinkedIn company address and the Icon below it holding the LinkedIn mark](/images/email-builder/blocks/07b-social-settings.png)
