...
<img src="/images/email-builder/blocks/08-button-settings.png" alt="The Button settings panel showing the URL box, Background color and Color, Size on Medium, Rounded corners on Normal, Width on Auto, Alignment, and the Text, Spacing, and Border groups" width="384" />
