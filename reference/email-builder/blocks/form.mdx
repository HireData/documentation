...
- **Text** holds the font, its size, letter spacing, and line height.
- **Spacing** holds **Margin** and **Padding**, and **Border** holds the colour, width, and radius.

![The Form settings panel showing the Form select, Leading Question, Background color and Color, Show Question, Size, Rounded corners, Width, Alignment, and the Text, Spacing, and Border groups](/images/email-builder/blocks/05-form-settings.png)
