...
![The Two Columns settings panel showing Background color, the five Layout buttons with 50-50 selected, the Gap slider at 24, the Column 1 and Column 2 block lists, Margin, and Padding](/images/email-builder/blocks/04-columns-settings.png)
...
![The same block rendered at 400 pixels wide, with the left column's paragraph and logo stacked above the right column's paragraph and button](/images/email-builder/blocks/04c-columns-stacked.png)
