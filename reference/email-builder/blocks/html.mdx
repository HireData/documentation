...
![The HTML block settings panel, showing a dark code editor with line numbers holding a single paragraph tag](/images/email-builder/blocks/09-html-settings.png)
