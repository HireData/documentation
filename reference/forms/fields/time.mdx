...
<img src="/images/forms-builder/fields/06-time.png" alt="A Time field card showing Question, Description, Image, the auto reply, the three evaluator switches, and a footer reading Optional, beside a preview showing a time box with a clock picker" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-time.png" alt="A condition on a Time question in the Logic tab, with the operator showing has response and no value box beside it" width="507" />
## Evaluation
