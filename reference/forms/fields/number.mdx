...
<img src="/images/forms-builder/fields/10-number.png" alt="A Number field card showing Question, Description, Image, Placeholder, Minimum Value, Maximum Value, Steps, the auto reply, the three evaluator switches with Criteria and Scoring on, and a footer reading Optional" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-number.png" alt="The Logic tab with the operator picker open on a Number condition, listing has response, is equal to, is not equal to, and the four comparison operators" width="507" />
## Evaluation
