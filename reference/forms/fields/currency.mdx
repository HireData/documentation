...
<img src="/images/forms-builder/fields/11-currency.png" alt="A Currency field card showing Question, Description, Image, Placeholder, Minimum Value, Maximum Value, Currency Symbol set to Euro, Steps, the auto reply, the three evaluator switches, and a footer reading Optional, beside a preview showing an answer box with a euro sign" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-currency.png" alt="The Logic tab with the operator picker open on a Currency condition, listing has response, is equal to, is not equal to, and the four comparison operators" width="507" />
## Evaluation
