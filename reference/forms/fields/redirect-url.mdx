...
description: "The Redirect URL ending in a HireData form. It sends the respondent straight to an address you set, such as a booking page, instead of showing a screen."
...
<img src="/images/forms-builder/fields/15-redirect-url.png" alt="A Redirect URL card holding a single Redirect URL box and a footer reading Redirect URL, beside a preview saying the field redirects the user automatically and will not have a display" width="650" />
## What it stores
