...
<img src="/images/forms-builder/fields/14-ending-screen.png" alt="An Ending Screen card showing Title, Description, Image, Button Text, Redirect URL, a Timer in seconds, and a footer with the Button and Redirect timer switches both on, beside a preview showing the title and a Submit Form button" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-endings.png" alt="The Logic tab showing an ending row with no Add Rule button, next to a question row that has one" width="507" />
## Evaluation
