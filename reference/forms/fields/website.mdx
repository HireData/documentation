...
<img src="/images/forms-builder/fields/04-website.png" alt="A Website field card showing Question, Description, Image, Placeholder, Minimum Length, Maximum Length, Validation Pattern, the auto reply, the three evaluator switches, and a footer reading Optional" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-website.png" alt="The Logic tab with the operator picker open on a Website condition, listing has response, is equal to, is not equal to, starts with, ends with, contains, and does not contain" width="507" />
## Evaluation
