...
<img src="/images/forms-builder/fields/05-date.png" alt="A Date field card showing Question, Description, Image, the auto reply, the three evaluator switches, and a footer reading Optional, beside a preview showing a dd/mm/yyyy box with a calendar picker" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-date.png" alt="A condition on a Date question in the Logic tab, with the operator showing has response and no value box beside it" width="507" />
<Note>
