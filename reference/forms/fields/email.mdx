...
<img src="/images/forms-builder/fields/02-email.png" alt="An Email field card showing Question, Description, Image, Placeholder, Minimum Length, Maximum Length, Validation Pattern, both auto replies, the three evaluator switches, and a footer reading Required, beside a preview showing an answer box with an @ mark" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-email.png" alt="The Logic tab with the operator picker open on an Email condition, listing has response, is equal to, is not equal to, starts with, ends with, contains, and does not contain" width="507" />
## Evaluation
