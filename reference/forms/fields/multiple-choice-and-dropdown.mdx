...
- **Add Data Source**, above the list, which fills the options from a saved list your workspace already keeps instead of options you type. See [Objects and data sources](/reference/forms/overview#objects-and-data-sources).
