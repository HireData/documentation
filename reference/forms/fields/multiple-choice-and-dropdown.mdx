...
<img src="/images/forms-builder/fields/09-multiple-choice.png" alt="A Multiple Choice field card showing Question, Description, Image, Conversational Button Text, the Options list with Add Data Source, the auto reply on invalid answer, the three evaluator switches, and a footer reading Multiple Choice, Single Answer, and Required, beside a preview listing the three options" width="650" />
The same field as a Dropdown, which adds a **Placeholder**:

<img src="/images/forms-builder/fields/09b-dropdown.png" alt="A Dropdown field card with a Placeholder setting above Conversational Button Text and a footer reading Dropdown, Single Answer, and Optional, beside a preview showing a closed menu" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-choice.png" alt="The Logic tab with the operator picker open on a Multiple Choice condition, listing has response, is equal to, is not equal to, is one of, and is not one of" width="507" />
## Evaluation
