...
<img src="/images/forms-builder/fields/13-file-upload.png" alt="A File Upload field card showing Question, Description, Image, Multiple, File type set to PDF, the auto reply, the three evaluator switches, and a footer reading Optional, beside a preview showing the Drop Files Here area" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-file-upload.png" alt="A condition on a File Upload question in the Logic tab, with the operator showing has response and no value box beside it" width="507" />
## Evaluation
