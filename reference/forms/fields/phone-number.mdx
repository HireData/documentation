...
<img src="/images/forms-builder/fields/03-phone-number.png" alt="A Phone Number field card showing Question, Description, Image, Placeholder, Minimum Length, Maximum Length, Validation Pattern, the auto reply, the three evaluator switches, and a footer reading Optional, beside a preview showing an answer box with a handset mark" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-phone-number.png" alt="The Logic tab with the operator picker open on a Phone Number condition, listing has response, is equal to, is not equal to, starts with, ends with, contains, and does not contain" width="507" />
## Evaluation
