...
<img src="/images/forms-builder/fields/01-short-and-long-text.png" alt="A Short Text field card showing Question, Description, Image, Placeholder, Minimum Length, Maximum Length, Validation Pattern, the auto reply, the three evaluator switches, and a footer reading Short Text and Optional" width="650" />
The same field switched to Long Text, with Criteria and Skills on:

<img src="/images/forms-builder/fields/01b-long-text.png" alt="A Long Text field card with Criteria and Skills switched on and a footer reading Long Text and Optional, beside a preview showing a multi-line answer box" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-text.png" alt="The Logic tab with the operator picker open on a Short Text condition, listing has response, is equal to, is not equal to, starts with, ends with, contains, and does not contain" width="507" />
## Evaluation
