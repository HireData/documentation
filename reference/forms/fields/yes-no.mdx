...
title: "Yes/No"
sidebarTitle: "Yes/No"
description: "The yes or no field in a HireData form, drawn as a checkbox or a toggle, with a separate WhatsApp auto reply for the Yes and the No answer."
keywords:
  - "binary"
  - "checkbox"
  - "toggle"
...
<img src="/images/forms-builder/fields/08-yes-no.png" alt="A Yes/No field card showing Question, Description, Image, Auto reply (Yes), Auto reply (No), the three evaluator switches with Criteria and Skills on, and a footer reading Checkbox and Optional" width="650" />
The same field switched to Toggle:

<img src="/images/forms-builder/fields/08b-yes-no-toggle.png" alt="The same field with a footer reading Toggle, beside a preview showing a slide switch instead of a tick box" width="650" />
## What it stores
...
<img src="/images/forms-builder/fields/operators-yes-no.png" alt="The Logic tab with the operator picker open on a Yes/No condition, listing has response, is equal to, and is not equal to, with the value box beside it reading Yes" width="507" />
## Evaluation
