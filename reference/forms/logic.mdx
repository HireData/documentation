...
<img src="/images/forms-builder/32-logic-tab.png" alt="The Logic tab listing four questions, each with an Add Rule button and an Always go to target, then the Endings divider and an ending with neither" width="520" />
## Anatomy of a rule

A rule reads `if <question> <operator> <value> then go to <field>`.

<img src="/images/forms-builder/04-logic-rule-and-fallback.png" alt="A logic rule on a Net Promoter Score question: if the score is less than or equal to 7, go to the follow-up question, with All other cases go to the ending" width="484" />
...
<img src="/images/forms-builder/15-logic-choice-branch.png" alt="A rule on a Multiple Choice question: if the answer is Yes, by email, go to the email question, with All other cases go to the ending" width="484" />
...
<img src="/images/forms-builder/17-logic-yes-no.png" alt="A rule on a Yes/No question: if the answer is Yes, go to the region question, with All other cases go to the experience question" width="499" />
...
<img src="/images/forms-builder/20-logic-file-has-response.png" alt="A rule on a File Upload question: if it has response, go to the ending, with All other cases go to the redirect" width="484" />
### Require two answers at once

**Add Condition** puts both conditions in one rule, and both have to match.

<img src="/images/forms-builder/19-logic-two-conditions.png" alt="A rule with two conditions: the satisfaction rating is 4 or more and the driving licence answer is Yes, then go to the ending" width="499" />
...
<img src="/images/forms-builder/18-logic-two-endings.png" alt="A rule on a Dropdown question sending North to the thank-you ending, with All other cases go to a redirect ending" width="484" />
...
<img src="/images/forms-builder/16-logic-always-go-to.png" alt="A question with no rules, showing Always go to pointing at a question further down the form" width="484" />
