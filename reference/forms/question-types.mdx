...
_What each question type in the form builder collects, what its settings do, and which logic rules you can attach to it._
...
Text settings such as **Question**, **Description**, and the placeholders accept variables, so a question can address the respondent by name or mention the vacancy. See [Variables](/variables/introduction).
...
- **Add Data Source** fills the options from a data source in your workspace, for example the values of a custom field from your ATS, instead of options you type. A question uses one or the other, never both.
