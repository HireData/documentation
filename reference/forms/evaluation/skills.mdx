...
<img src="/images/forms-builder/evaluation/06-skills-list.png" alt="The Skills block open with two skills, Availability and Communication, and the description popup open on the first" width="581" />
...
<img src="/images/forms-builder/evaluation/07-skills-rules.png" alt="A Yes/No question in the Skills block with a rule that adds a weight of 2 to Availability when the answer is Yes" width="488" />
