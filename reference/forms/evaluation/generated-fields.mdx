...
description: "Define custom output fields on a HireData form and let AI fill them from the whole response, then read the generated values in an automation."
