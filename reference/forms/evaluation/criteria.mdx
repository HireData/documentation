...
<img src="/images/forms-builder/evaluation/01-criteria-field-list.png" alt="The Criteria block open, listing the form's questions with a switch each and one question switched on" width="504" />
...
<img src="/images/forms-builder/evaluation/02-criteria-rules.png" alt="A Yes/No question in the Criteria block, set to Must-have and Use answer rules, expecting the answer Yes" width="488" />
### Expected answers
...
<img src="/images/forms-builder/evaluation/03-criteria-ai.png" alt="A long text question in the Criteria block, set to Nice-to-have and Evaluate with AI, with a note telling the AI what to look for" width="488" />
