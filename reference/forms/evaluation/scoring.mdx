...
A rule is a set of conditions plus **How many points should be awarded?**. The conditions read the same way as a [Criteria](/reference/forms/evaluation/criteria#expected-answers) expectation, with the same operators per field type, and **Add condition** brings the **All** and **Any** switch. **Add rule** adds another rule underneath.
