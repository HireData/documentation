...
<img src="/images/forms-builder/testing/01-interactive-preview.png" alt="The Interactive Preview showing the first question of the form with its rating scale, the Next button, and the language picker" width="650" />
...
<img src="/images/forms-builder/testing/02-conversational-preview-start.png" alt="The Conversational Preview setup screen with the language picker, the Objects section, the optional first message box, and the Start Testing button" width="650" />
...
<img src="/images/forms-builder/testing/03-conversational-preview-chat.png" alt="A conversation in progress: the first question with a Choose button, the tester's reply, and the follow-up question the logic picked" width="650" />
...
<img src="/images/forms-builder/testing/04-preview-modal.png" alt="The preview window in its mobile view, with the copy button, the device switcher, the refresh button, and the language picker across the top" width="494" />
