...
The evaluation runs on its own as soon as there is an answer, and again a moment after you change one. There is no button to press. **Reset answers** at the bottom clears everything.
