---
title: "Form builder tour: tabs, field types, and shared settings"
...
<img src="/images/forms-builder/31-builder-at-a-glance.png" alt="The form builder: the form name and toolbar across the top, the Content, Logic, and Evaluation tabs with the field list on the left, and the Interactive Preview on the right" width="650" />
### Content tab
...
<img src="/images/forms-builder/01-add-content-palette.png" alt="The Add Content palette with its Recommended list and the Text, Contact Info, Temporal, Choice, Numeric, Rating, Other, and Ending groups" width="650" />
### Logic tab {#logic-tab}
...
<img src="/images/forms-builder/25-builder-toolbar.png" alt="The form builder toolbar, showing Save, the preview button, Publish, the brand selector, the five drawer buttons, and the more menu" width="650" />
...
Text settings such as **Question**, **Description**, and the placeholders accept variables, so a question can address the respondent by name or mention the vacancy. Each variable shows as a badge with the field's display name. Hover it for the value and any modifiers, and watch for an orange badge, which means the form does not know the key. Some variables only become available after you link their object to the form, see [Objects and data sources](#objects-and-data-sources). For the syntax, see [Variables](/variables/introduction).
...
<img src="/images/forms-builder/02-question-card-common-settings.png" alt="A Dropdown field card showing Question, Description, Image, Placeholder, Conversational Button Text, the options with Add Data Source, the three evaluator switches, and a footer reading Dropdown, Single Answer, and Optional" width="540" />
...
<img src="/images/forms-builder/22-display-and-requirements.png" alt="The Display & requirements popup on a field card, with the Hidden, Required, and Always include switches" width="550" />
...
<img src="/images/forms-builder/26-settings-drawer.png" alt="The Settings drawer with Make form public, Logo, Alignment, Font Family, Text Color, Scale, the collapsed Input and Background sections, Button Text, and Border radius" width="420" />
...
<img src="/images/forms-builder/27-translation-editor.png" alt="The New Translation panel with Dutch selected, the Create AI translation button, the Settings group, and the first field expanded to Question, Description, Min Label, and Max Label" width="480" />
...
<img src="/images/forms-builder/28-new-form-templates.png" alt="The New Form dialog showing the Candidate and Contact tag filters, the Blank Form card, and the recruitment form templates" width="650" />
