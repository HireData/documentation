...
description: "Fill a HireData form's Multiple Choice or Dropdown question from a saved list instead of typed options, and what changes when you edit a shared list."
...
<img src="/images/forms-builder/34-data-source-library.png" alt="The Data Sources window listing the workspace's saved lists, with Countries selected and its Name, Label, Description, Value, and Avatar shown beside the Select Data Source button" width="650" />
...
<img src="/images/forms-builder/36-choice-with-data-source.png" alt="The Options section of a Dropdown card with a data source attached, showing Remove Data Source, the Countries source, and a single Auto reply (on answer)" width="503" />
...
<img src="/images/forms-builder/35-data-source-editor.png" alt="The Countries data source open for editing, with Name, Label, Description, Value, Avatar, the Filters section, and a Save button" width="404" />
