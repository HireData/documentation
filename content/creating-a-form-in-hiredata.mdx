...
Then, open the **Forms** page via the **Settings** and click [New Form]. You can create a blank form or select any of the available templates:
...
### 1.1. Click the type of question you want to add or the [+] icon to add other questions
