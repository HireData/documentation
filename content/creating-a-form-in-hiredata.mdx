...
Which operators each question type supports and how HireData picks between several rules are in the [Logic tab reference](/reference/forms/overview#logic-tab).
