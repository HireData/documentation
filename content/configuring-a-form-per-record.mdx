...
You can configure a form per record once the form is linked to an object, and that object is first in the form's list. Link it on the **Objects** panel in the form builder, described in [Objects and data sources](/reference/forms/overview#objects-and-data-sources).
