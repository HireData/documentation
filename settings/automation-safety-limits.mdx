...
description: "Configure automation safety limits in HireData to cap how many messages a contact receives, prevent runaway sends, and keep your recruitment outreach on track."
...
<Note>
  Landed here from a **Run Cancelled – Send Limits Exceeded** or **Run Cancelled – Send Limits Per Automation Exceeded** error? Those cancellation reasons are explained, with the fix for each, in [Why Didn't My Automation Run?](/knowledge-base/why-didnt-my-automation-run)
</Note>
...
<Steps>
  <Step title="Navigate to the Safety Limits section in HireData">
    ![The Safety Limits section](/images/intercom/75459538-2025-11-19_19h08_53.png)
  </Step>
  <Step title="Adjust the limits according to your outreach strategy">
...
<Steps>
  <Step title="Navigate to the Automation you wish to set a Safety Limit on">
    ![Navigating to and selecting an automation](/images/intercom/75469444-2025-11-19_19h38_31.png)
  </Step>
  <Step title="Click on the three vertical dots in the upper right of the screen, then choose Settings">
    ![Navigating to Settings in the automation](/images/intercom/75463663-2025-11-19_19h34_44.png)
  </Step>
  <Step title="Set the Safety Limit that best fits your automation and click Save">
