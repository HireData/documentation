---
title: "Runs"
description: "Learn what runs are in HireData, how they capture each step of a triggered automation, and how to read run logs to troubleshoot recruitment workflows fast."
---
...
If a run was cancelled and you want to know what the cancellation reason means and how to fix it, see [Why Didn't My Automation Run?](/knowledge-base/why-didnt-my-automation-run), which has a section per reason.
