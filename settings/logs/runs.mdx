---
title: "Runs: read automation timelines and step details"
...
_When an event from your connected app, e.g. Carerix, Salesforce, etc., triggers an automation, HireData creates a run. This run represents the full process that follows from the initial trigger to each step of your automation. This article walks through what runs are, how to find and read them, and how they can help you troubleshoot your automations._
...
If you're unsure why a run was cancelled or completed, or want help interpreting the run's steps, feel free to contact our team at [support@hiredata.com](mailto:support@hiredata.com). If you do, include:
