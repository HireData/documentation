...
_When an automation is triggered by an event from your connected app, e.g. Carerix, Salesforce, etc., a Run is created. This Run represents the full process that follows from the initial trigger to each step of your automation. This article walks through what runs are, how to find and read them, and how they can help you troubleshoot your automations._
...
[To explore an individual run, click the \[Details\] button next to the run for a short overview or open the dropdown menu and click \[View Run\].](/knowledge-base/run-cancellation-reasons)
