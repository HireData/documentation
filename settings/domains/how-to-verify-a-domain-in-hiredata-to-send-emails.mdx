...
sidebarTitle: "Verify a Domain"
description: "Verify your domain in HireData with the right DNS records so you can start sending emails from your own address with strong deliverability and authentication."
---
