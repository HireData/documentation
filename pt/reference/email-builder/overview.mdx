---
title: "Visão geral do Email builder"
...
Todas as cores e fontes de um email novo começam como um valor da marca que escolher em **Brand**, e o painel nomeia o valor em vez de mostrar um código hexadecimal, como "Theme: Palette Surface Color".
