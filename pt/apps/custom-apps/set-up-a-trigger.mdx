...
description: "Configure um trigger na HireData: descreva os dados recebidos, teste o payload e transforme-o em automações prontas para uso em qualquer app personalizada."
---
...
A HireData rejeita pedidos com um método diferente do configurado.
...
Pode marcar qualquer pedido como teste adicionando um header:
