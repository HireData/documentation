...
description: "Maak een trigger in Custom Apps, beschrijf de data die HireData ontvangt, test hem met sample events en gebruik hem in je automatiseringen."
---
...
HireData weigert verzoeken met een andere methode dan is geconfigureerd.
...
Je kunt elk verzoek als test markeren door een header toe te voegen:
