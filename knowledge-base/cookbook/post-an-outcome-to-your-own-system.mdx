...
description: "Build an automation that POSTs a JSON summary to your API when a conversation ends, authenticates with a bearer token, and reuses the response later."
...
Open the **Start** block. Select **HireData** as the app, then **Conversation** as the object and **Ended** as the trigger. The automation now runs once each time a conversation finishes.
