...
### 1. Select the candidate trigger

Open the **Start** block and select your ATS. Select the candidate-created or candidate-updated trigger that best matches when you want HireData to check the profile.
