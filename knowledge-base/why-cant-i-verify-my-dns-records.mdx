...
description: "Getting a 404 error or no response when clicking Verify DNS in HireData? Install the Email app first — DNS records can only be generated and verified after that."
---
