...
_This guide will introduce you to all the basics you need to know about the [Task History] tab. You will learn how to use the filters to see completed and cancelled tasks, where to look for event details, and how to replay them. Scroll to the end of the page if you prefer a video format._
