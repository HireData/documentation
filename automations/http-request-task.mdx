...
{/* screenshot: Response section with properties in both the Success and Error trees */}
...
{/* screenshot: Test dialog after a successful send — status, code, and duration, with the response body below */}
...
{/* screenshot: Advanced tab — Description, Timeout, Retries, Backoff, and the two failure switches */}
