...
Individual Claude plans without an organisation catalog can use the [manual MCP connection](/apps/mcp/connect-hiredata-to-your-ai-assistant) instead; this provides the live HireData tools without the five bundled skills.
