...
<Steps>
  <Step title="Add the HireData marketplace">
    ...
    ![Chatgpt Plugins Add Marketplace](/images/chatgpt-plugins-add-marketplace.png "Chatgpt Plugins Add Marketplace")
    ...
    ![Chatgpt Add Marketplace Source](/images/chatgpt-add-marketplace-source.png "Chatgpt Add Marketplace Source")
  </Step>
  <Step title="Install HireData">
    **HireData** now appears under the **HireData Skills** marketplace. Click **\[Install\]**.

    ![Chatgpt Plugin Hiredata Install](/images/chatgpt-plugin-hiredata-install.png "Chatgpt Plugin Hiredata Install")
  </Step>
...
<Steps>
  <Step title="Add the HireData marketplace">
    ...
    ![Claude Plugins Add Marketplace](/images/claude-plugins-add-marketplace.png "Claude Plugins Add Marketplace")
    ...
    ![Claude Add Marketplace Url](/images/claude-add-marketplace-url.png "Claude Add Marketplace Url")
  </Step>
  <Step title="Install HireData">
    **HireData** appears under the **skills** marketplace on the **Personal** tab. Click the **\[\+\]** on its card, or open the card and click **\[Install\]**.
    ...
    ![Claude Plugin Hiredata Install](/images/claude-plugin-hiredata-install.png "Claude Plugin Hiredata Install")
  </Step>
  <Step title="Connect your HireData account">
