...
- For ChatGPT: the desktop app, or the Codex CLI with `codex plugin` support. ChatGPT on the web cannot install plugins from marketplaces.
...
<Steps>
  <Step title="Add the HireData marketplace">
    ...
    ![The Add a marketplace option in ChatGPT's Plugins settings](/images/mcp/chatgpt-plugins-add-marketplace.png)
    ...
    ![HireData/skills entered in the Source field of ChatGPT's Add plugin marketplace dialog](/images/mcp/chatgpt-add-marketplace-source.png)
  </Step>
  <Step title="Install HireData">
    **HireData** now appears under the **HireData Skills** marketplace. Click **\[Install\]**.

    ![The HireData plugin with its Install button under the HireData Skills marketplace in ChatGPT](/images/mcp/chatgpt-plugin-hiredata-install.png)
  </Step>
...
<Note>
  ChatGPT on the web cannot install plugins from marketplaces. Use the desktop app, or [connect HireData over MCP only](/apps/mcp/connect-hiredata-to-your-ai-assistant).
</Note>
...
<Steps>
  <Step title="Add the HireData marketplace">
    ...
    ![The Add marketplace option in Claude's Plugins settings](/images/mcp/claude-plugins-add-marketplace.png)
    ...
    ![HireData/skills typed into the URL field of Claude's Add marketplace dialog](/images/mcp/claude-add-marketplace-url.png)
  </Step>
  <Step title="Install HireData">
    **HireData** appears under the **skills** marketplace on the **Personal** tab. Click the plus on its card, or open the card and click **\[Install\]**.

    ![The HireData plugin card with its plus button under the skills marketplace in Claude](/images/mcp/claude-plugin-hiredata-install.png)
  </Step>
  <Step title="Connect your HireData account">
...
- **There is no plugin option in ChatGPT on the web:** the web app cannot install plugins from marketplaces. Use the desktop app, or [connect over MCP only](/apps/mcp/connect-hiredata-to-your-ai-assistant).
