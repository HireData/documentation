...
| --- | --- | --- |
| HireData plugin | Every HireData skill and the MCP connection, updated from one button | You use ChatGPT desktop, Codex, or Claude and want both HireData knowledge and tools |
