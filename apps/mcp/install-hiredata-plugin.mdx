...
- [**Map the staffing lifecycle**](/apps/mcp/hiredata-skills#map-the-staffing-lifecycle) — the recruitment domain knowledge the other skills use to read a request correctly.
