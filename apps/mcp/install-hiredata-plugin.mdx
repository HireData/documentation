...
description: "Get HireData's five recruitment skills — plan activations, create triggers, forms, email templates, and WhatsApp templates — plus the MCP connection by installing the HireData plugin in ChatGPT, Codex, or Claude."
