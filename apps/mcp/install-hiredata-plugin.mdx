...
description: "Install the HireData plugin in ChatGPT, Codex, or Claude to add every recruitment, diagnostic, and issue-reporting skill plus the MCP connection."
...
<Steps>
  <Step title="Add the HireData marketplace">
    Open **Settings** \> **Plugins**, click **\[Add\]**, then select **Add a marketplace**.
...
<Steps>
  <Step title="Add the HireData marketplace">
    Open **Settings** \> **Plugins**, click **\[Add\]**, then select **Add marketplace**. On a personal Claude plan, Claude first asks where to add from. Select **Add from a repository** rather than **Browse Anthropic sources**.
