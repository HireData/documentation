...
The task tells you what moved and where; you still press update on the plugin, or re-run the install prompt, yourself. Add _"package anything new as a .skill file and send it to me"_ and it hands you the files ready to save.
