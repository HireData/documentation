...
In a conversation, click the **\+** button, select **Connectors**, and make sure **HireData** is enabled. Then just ask. For example: _"Create a candidate NPS email template in our brand style and send me a test."_
...
1. In **Microsoft Copilot Studio**, open your agent's **Tools** page and select **Add a tool** \> **New tool** \> **Model Context Protocol**.
...
3. Select **OAuth 2.0** authentication with **Dynamic discovery**, create the connection, and add the tool to the agent.
