...
<Note>
  If you use ChatGPT, Codex, or Claude, you can [install the HireData plugin](/apps/mcp/install-hiredata-plugin) to get five recruitment workflow skills together with this MCP connection. Continue with this guide when you want MCP tools only, or use Gemini or another MCP client.
</Note>
