...
description: "Connect ChatGPT, Claude, Gemini, or another AI assistant to the official HireData MCP server, authorize your workspaces, and use HireData safely."
keywords: ["HireData MCP", "HireData Model Context Protocol", "connect HireData to ChatGPT", "connect HireData to Claude", "connect HireData to Gemini", "HireData AI assistant"]
related: ["/apps/mcp/install-hiredata-plugin"]
---

_HireData has an official MCP (Model Context Protocol) connection. Any AI assistant that supports MCP can connect to HireData with your own account. It sees only the workspaces you grant and works with the same permissions you have in the app. Every request is verified and recorded in the activity log. This guide shows you how to set up the connection in ChatGPT, Claude, and Gemini._
