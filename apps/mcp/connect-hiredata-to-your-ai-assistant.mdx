...
description: "Connect ChatGPT, Claude, Gemini, or Microsoft Copilot to the official HireData MCP server, authorize your workspaces, and use HireData safely."
...
<Note>
  If you use ChatGPT, Codex, or Claude, you can [install the HireData plugin](/apps/mcp/install-hiredata-plugin) to get six recruitment and issue-reporting skills together with this MCP connection. Continue with this guide when you want MCP tools only, or use Gemini or another MCP client.
</Note>
