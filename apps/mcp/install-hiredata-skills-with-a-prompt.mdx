...
HireData adds skills over time, so check [the repository](https://github.com/HireData/skills) for today's list, or use the [check prompt](/apps/mcp/keep-hiredata-skills-up-to-date#check-whether-you-re-out-of-date).
