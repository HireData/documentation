...
description: "Use a copy-paste prompt to have your AI assistant fetch and package the HireData skills when you cannot install the plugin in your assistant."
...
<Steps>
  ...
  <Step title="Save it as a skill">
    In Claude, go to **Customize** \> **Skills**, click **\[Add\]**, select the option to upload a skill file, and pick the zip you just downloaded.
