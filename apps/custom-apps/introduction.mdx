...
description: "Use Custom Apps to connect any tool to HireData through webhooks, describe the data it sends, and turn incoming events into recruitment automations."
---
