...
description: "Create a Custom App trigger in HireData, describe the payload it receives, test it with sample data, and use it to build fully custom recruitment automations."
---
