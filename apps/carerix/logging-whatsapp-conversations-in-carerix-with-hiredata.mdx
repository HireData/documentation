...
sidebarTitle: "Log WhatsApp chats"
description: "Automatically log completed WhatsApp conversations from HireData into Carerix, so every candidate and client interaction stays visible across your team."
---
...
HireData configures the [Message] object automatically, so you will have to change it to [Conversation] from the [Edit] button. Here are all the object options we support in this case:
...
Once activated, this automation ensures that every WhatsApp conversation (started or ended) is automatically recorded in Carerix, allowing your team to maintain a complete communication history. This improves tracking, transparency, and collaboration across teams.
