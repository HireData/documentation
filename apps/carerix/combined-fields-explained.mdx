...
description: "Learn how HireData's combined fields pick a value from Carerix: which email address is used first, which phone number, and the priority order behind each."
...
If you're wondering which email address HireData picks when a record has more than one — business or private, primary or secondary — this is the field that decides, and the priority order is below.
