...
Once the connection is established, HireData automatically schedules a sync to import your users' data from Carerix. This is required so your users can automatically send different types of communication through the platform. HireData then schedules daily resyncs in case you make any changes in your Carerix profile.
