...
Once you've set up the trigger, it's essential to add filters to ensure that the automation only runs under specific conditions. Follow these steps:
...
_4.2. Select the recipient of the survey:_
