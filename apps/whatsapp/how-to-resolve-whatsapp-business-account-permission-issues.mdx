...
- The WABA must have [valid payment details](https://help.hiredata.com/en/articles/255992-add-a-valid-payment-method-for-whatsapp) configured in the Meta Business Manager.
