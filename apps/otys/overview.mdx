...
After you create the connection, HireData imports connection data such as users, objects, fields, and statuses and schedules daily resyncs. If you add or change something in OTYS and need it immediately, run a [manual sync](/apps/otys/manually-sync-otys-with-hiredata).
...
<Steps>
  ...
  <Step title="Create an automation">
    Select OTYS as the trigger app, select the object and event, then include every related record you will need later in the workflow.
  </Step>
