...
_Click [+ New Connection] and start connecting your OTYS_

![](/images/intercom/3a4e37571212.png)

## Step 3: Adding your OTYS account name and API key

For a successful integration, you need two critical pieces of information: your OTYS account name and the API key. If you're unsure about these details, reach out to your OTYS representative for assistance.
