...
description: "Step-by-step guide to connect HireData with OTYS, authenticate the integration, and start automating recruitment workflows between the two platforms."
---
