...
After you've logged in to your Vincere environment and given your consent to HireData, you've finished setting up the connection between Vincere and HireData. Check out the tutorial for a full step-by-step guide on how to set up the connection.
