...
Clicking the first building block, you'll be able to select which app to link this to
...
Choosing the timing you would like the trigger to adhere to
...
- **Type:** Select the Item Type you would like the Task to correspond to. This can be:
