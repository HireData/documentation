...
description: "Send email newsletters to your talent pool from HireData: build the audience, design the template, and schedule the send to keep candidates engaged."
---
...
_HireData handles the entire process in one place, from defining your audience to designing the email and scheduling it. It's a simple, reliable way to keep your candidates engaged, with complete control and visibility from start to finish._
...
Give your automation a clear name, such as "Newsletter". Select your app, e.g. Carerix, and the connection. Then, select the Candidate object and schedule the automation for when you want to send the newsletter (the date can be edited later).
...
### 3.4. Select email recipient and sender
...
Once everything looks good, click the [Activate] button in the top right corner. Your automation is then live and runs on the schedule you've set.
