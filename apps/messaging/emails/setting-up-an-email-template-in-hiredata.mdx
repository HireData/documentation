...
description: "Build reusable email templates in HireData with dynamic variables and brand styling, then plug them into your recruitment automations and newsletters."
...
Open the **Emails** page from the **Settings** and click the [New Email] button. You can use any of the available email templates that HireData has created for you, or create a **Blank Email**.
...
#### 1. Add a new block from the **Blocks** menu by clicking the [+] icon
...
If your email should collect responses (e.g., company feedback, confirmation of availability, etc.), you can add a form, again by clicking the [+] in the **Blocks** section and selecting "Form" from the list:
