...
Meta (Facebook) bills WhatsApp template costs directly, based on the message type and the region where it is sent. These charges appear separately on your Meta invoice.
