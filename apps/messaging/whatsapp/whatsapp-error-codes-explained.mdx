...
These errors happen when you send too many messages in a short period of time.
...
Meta has permanently disabled the template following repeated quality issues.
