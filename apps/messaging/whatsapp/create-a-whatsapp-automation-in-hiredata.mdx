...
This guide walks you through setting up a WhatsApp automation in HireData. With this integration, you can automate tasks such as collecting and updating candidate details (like availability status) and notifying candidates about new job openings. This improves candidate experiences and streamlines your recruitment processes.
...
When the conversation in WhatsApp ends, HireData updates the fields specified in this task in your app.
