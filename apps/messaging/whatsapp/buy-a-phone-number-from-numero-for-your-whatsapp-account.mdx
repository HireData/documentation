...
sidebarTitle: "Buy a phone number"
description: "Buy a dedicated phone number from Numero and connect it to your WhatsApp Business account so you can start messaging candidates directly from HireData."
---
...
**[Numero eSIM](https://www.numeroesim.com/virtual-numbers/all-countries)** is an app that lets you purchase virtual phone numbers from various countries worldwide. You can use them for calls, texts, and verification purposes on different platforms.
