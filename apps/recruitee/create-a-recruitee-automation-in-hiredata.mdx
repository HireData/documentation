...
You can add filters directly to the trigger, ensuring the automation only runs when specific conditions are met. You can also create them as a separate building block, which is especially useful when you need multiple filter sets for more complex workflows. Follow these steps:
...
### 5.5 Select the recipient of the message
