...
<Steps>
  <Step title="Connect your recruitment app">
    Open **Settings** \> **Apps**, select your ATS, and create a connection.
  ...
  <Step title="Create a blank automation">
    ...
    2. Select the object, such as Candidate, Match, Application, or Procedure.
    3. Select the event that should start the workflow.
