...
The popover is read-only. To change the expression, see [Editing a badge](/variables/introduction#editing-a-badge).
...
The badge is tinted to set it apart from a field, and carries the icon of the literal's type.
