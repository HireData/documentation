...
Type `{{` anywhere in the **Input** box and a picker appears, listing every variable available to this template with its key and its type. Keep typing to filter, then choose one to insert it. It appears as a badge with the field's name, and hovering it shows the value.
