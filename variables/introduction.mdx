...
<img src="/images/email-builder/24-variable-badges.png" alt="Four badges in an email paragraph: Recipient: First Name, Recipient: First Name with a wand icon and a 3, a tinted 'text' badge with a wand icon, and an orange documentation_missing_key badge with a warning icon" width="608" />
